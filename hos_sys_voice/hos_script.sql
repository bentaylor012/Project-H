...
CREATE TABLE `patients` (
  ...
  `PHistory` varchar(45) DEFAULT NULL,
  `PAddress` varchar(45) DEFAULT NULL,
  `PDoctor` varchar(45) DEFAULT NULL,
  `PNurse` varchar(45) DEFAULT NULL,
  `PWard` varchar(45) DEFAULT NULL,
  `PPayment` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`PName`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-01-05 17:35:39
